...
const dummyData_services = [
  Services(
    ...
    types: ['There are several types of upscaling strategies that we provide to enhance business upscale status:'
        '\n - Product Upscaling'
        '\n - Price Upscaling'
        '\n - Brand Upscaling'
  ...
  Services(
    ...
    details: ['Taking over a business refers to the acquisition or control of an existing company by another entity. It typically involves the transfer of ownership, management, assets, and liabilities from one company to another. '],
    types: ['There are several types of takeovers that can occur in a business context:'
        '\n - Management Takeover'
        '\n - Friendly Takeover'
        '\n - Hostile Takeover'
        '\n - Asset Takeover'
  ...
  Services(
    ...
    details: ['Increasing sales refers to the process of generating more revenue for a business by selling more of its products or services. This can be achieved through various strategies and techniques depending on the nature of the business and its target audience. '],
    types: ['There are different types of increase sales strategies that we provide for businesses to adopt, including:'
  ...
  Services(
    ...
    details: ['Improving financial decisions refers to the process of making better choices related to managing money, investments, and financial planning. It involves considering various factors such as risks, costs, benefits, and long-term goals to make informed decisions that lead to improved financial outcomes.'],
    types: ['We provide different types of strategies to improve financial decisions:'
        '\n - Budgeting'
  ...
  Services(
    ...
    details: ['Marketing strategies refer to a set of activities and tactics that businesses employ to promote and sell their products or services to target customers. These strategies aim to maximize profit and gain a competitive advantage in the marketplace.'],
    types: ['We provide various types of marketing strategies, including:'
        '\n - Target Marketing'
        '\n - Differentiation'
        '\n - Branding'
        '\n - Content Marketing'
  ...
  Services(
    ...
    details: ['Other business problems can vary widely depending on the industry and company.'],
    types: ['Some common types of business problems include:'
