                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Dismissible(
                          key: Key(executiveData['id']), // Unique key for each item
                           ...
                           onDismissed: (direction) async {
                             ...
                             if (deleteConfirmed) {
                               ...
                               await FirebaseFirestore.instance
                                   ...
                                   .doc(executiveData['id']) // Use the document ID for deletion
                                   .delete();
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                executiveData['exname'] ?? 'N/A',
                                                style: TextStyle(color: Colors.white, fontSize: 15),
                                              ),
                                              Text(
                                                'ID: ${executiveData['exid'] ?? 'N/A'}',
                                                style: TextStyle(color: Colors.white, fontSize: 15),
                                              ),
                                              Text(
